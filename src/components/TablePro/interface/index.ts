...
import { ProTableProps } from "@/components/TablePro/index.vue";
...
export type ProTableInstance = Omit<InstanceType<typeof TablePro>, keyof ComponentPublicInstance | keyof ProTableProps>;
