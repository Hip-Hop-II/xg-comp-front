...
const columns = reactive<ColumnProps[]>([
  ...
  { prop: "payerPhone", label: "被投诉人名称", width: 140 },
  { prop: "payerPhone", label: "投诉人userId", width: 140, search: { el: "input" } },
  { prop: "mchid", label: "商户编号", width: 110 },
  { prop: "transactionId", label: "支付订单号", width: 110 },
  ...
  { prop: "outTradeNo", label: "图片", width: 90 },
  { prop: "outTradeNo", label: "商品编号", width: 100 },
  { prop: "outOrderNo", label: "商品名称", width: 100 },
  { prop: "outOrderNo", label: "代理商", width: 100 },
  { prop: "outOrderNo", label: "销售人员", width: 100 },
  { prop: "outOrderNo", label: "交易单号", width: 100, search: { el: "input" } },
  {
    prop: "outOrderNo",
    label: "下单时间",
    width: 100,
