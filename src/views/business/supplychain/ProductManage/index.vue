<template>
  <div class="table-box" v-if="dataSource.length">
    <TablePro
      ref="TableProRef"
      :columns="columns"
    ...
    >
      ...
      <template #action="scope">
        <el-space>
          ...
          <el-button type="primary" link @click="onEdit(scope.row)">上架</el-button>
          <el-button type="primary" link @click="onEdit(scope.row)">下架</el-button>
          <el-button type="primary" link @click="onEdit(scope.row)">预览</el-button>
          <el-button type="primary" link @click="onEdit(scope.row)">放入回收站</el-button>
        </el-space>
      </template>
    </TablePro>
  </div>
...
const columns = reactive<ColumnProps[]>([
  ...
  { prop: "sellStatus", label: "是否上架", enum: userStore.dataType.YesOrNo, fieldNames: { label: "value", value: "type" } },
  {
    prop: "sellHot",
    label: "是否热销",
