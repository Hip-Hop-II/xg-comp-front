  ...
  <div class="table-box">
    ...
    >
      ...
      <template #tableHeader="">
        <el-button type="primary" :icon="CirclePlus" @click="openDrawer('发起转账')">发起转账</el-button>
      </template>
      <!-- 表格操作 -->
      <template #action="scope">
        ...
        <el-button
          ...
          link
          :icon="Back"
          @click="consumerPwdSetClick(scope.row)"
        >
          撤销
        </el-button>
...
import {
  ...
  fundSettlementAddApi,
  fundSettlementCancelApi,
  fundSettlementCommitApi
...
const openDrawer = (title: string, row: any = {}) => {
  const params = {
    ...
    isView: title === "查看",
    row: { ...row },
    api: title === "发起转账" ? fundSettlementAddApi : undefined,
...
const consumerPwdSetClick = (row: any = {}) => {
  fundSettlementCancelApi({
    ...
    ElMessage.success({ message: `撤销成功！` });
