...
import { accountChangeLinePageListApi } from "@/api/modules/finance";
...
const getTableList = (params: any) => {
  let newParams = JSON.parse(JSON.stringify({ ...params, platformRole: "subMerchant" }));
  return accountChangeLinePageListApi(newParams);
};
