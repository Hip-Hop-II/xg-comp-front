  ...
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" :size="'600px'" :title="`${drawerProps.title}`">
    ...
    >
      <div v-if="drawerProps.title === '积分发放'">
        ...
        <el-form-item label="发放积分" prop="value">
    ...
    <template #footer>
      ...
      <el-button v-show="drawerProps.title === '积分发放'" type="primary" @click="consumerAccountSubmit">提交</el-button>
      <el-button v-show="!drawerProps.isView && drawerProps.title !== '积分发放'" type="primary" @click="handleSubmit">
        提交
      </el-button>
    </template>
  </el-drawer>
